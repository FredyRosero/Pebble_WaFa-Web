...
static void main_window_load(Window *window) {
  ...
  text_layer_set_text(s_humedad_layer, "Cargando...");
  
  s_humedad_font = fonts_load_custom_font(resource_get_handle(RESOURCE_ID_FONT_PERFECT_DOS_20));
  text_layer_set_font(s_humedad_layer, s_humedad_font);
  layer_add_child(window_get_root_layer(window), text_layer_get_layer(s_humedad_layer));  
